    ...
    <div id="main">
        ...
        <nav>
            <ul>
                ...
                <a href="admin-services.php" style="border-bottom:4px solid rgb(200,170,0);color: rgb(200,170,0)">
        ...
        <div id="main-body-content">
            ...
            <div class="card active-card">
                <div id="add-services-button">
                    <span class="add service" onclick="showForm(0)">
                        <h1 style="padding-right:10px">+</h1> Services
                    </span>
                </div>
        ...
        <div class="form service-upload" id="0">
            ...
            <form id="service-upload-form" class="upload-form">
                ...
                <i class="fa fa-envelope-open-text">
                    <input type="text" placeholder="Service Name" maxlength="30" name="serviceName" required /></i>
                <i class="fa fa-link">
                    <input id="service-url" placeholder="Service URL" name="serviceUrl" type="url" multiple accept="video/*" required /></i>
                <input id="choose-service-image" name="file[]" type="file" multiple accept="img/jpg, img/png, img/jpeg, img/gif" required />
                <div class="upload-button">
                    <button type="submit" name="submit" id="upload-service">
                        UPLOAD
                    </button>
                </div>
            </form>
