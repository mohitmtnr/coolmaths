    ...
    <div id="main">
        ...
        <nav>
            <ul>
                ...
                <a href="admin-books.php" style="border-bottom:4px solid rgb(200,170,0);color: rgb(200,170,0)">
                    <li title="Edit books">
                        <i class="fa-solid fa-book" style="color: rgb(200,170,0)"></i>
                    </li>
                </a>
        ...
        <div id="main-body-content">
            ...
            <div class="card active-card">
                <div id="add-books-button">
                    <span class="add book" onclick="showForm(0)">
                        <h1 style="padding-right:10px">+</h1> Books
                    </span>
                </div>
        ...
        <!-- form 0 -->
        <div class="form book-upload" id="0">
            <center>
            ...
            <form id="book-upload-form" class="upload-form">
                ...
                <i class="fa fa-envelope-open-text">
                    <input type="text" placeholder="Book Name" maxlength="30" name="bookName" required /></i>
                <i class="fa fa-envelope-open-text">
                    <input type="text" placeholder="Type Text About The Book" maxlength="30" name="bookText" required /></i>
                <i class="fa fa-link">
                    <input id="book-url" placeholder="Book URL" name="bookUrl" type="url" multiple accept="video/*" required /></i>
                <input id="choose-book-image" name="file[]" type="file" multiple accept="img/jpg, img/png, img/jpeg, img/gif" required />
                <div class="upload-button">
                    <button type="submit" name="submit" id="upload-book">
                        UPLOAD
                    </button>
                </div>
            </form>
