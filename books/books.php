...
<head>
    ...
    <link rel="icon" href="../coolmaths-icon/256x256.ico" type="image/x-icon">
    ...
    <div id="main">
        ...
        <nav>
            <ul>
                ...
                <a href="../books/books.php" style="border-bottom:4px solid rgb(200,170,0);color: rgb(200,170,0)">
                    <li title="books">
        ...
        <div id="main-body-content">
            ...
            <div class="card active-card">
                <div id="coolmaths-books" style="background-color:rgb(25, 28, 36);width:100%;height:100%;display:block">
                    <center>
                        <h1 style="color:white; padding:30px" data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" data-aos-duration="3000">Purchase Books</h1>
                    </center>
                    <div class="books" id="book-content">
