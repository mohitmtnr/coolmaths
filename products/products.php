    ...
    <div id="main">
        ...
        <nav>
            <ul>
                ...
                <a href="../products/products.php" style="border-bottom:4px solid rgb(200,170,0);color: rgb(200,170,0)">
        ...
        <div id="main-body-content">
            ...
            <div class="card active-card">
                <div id="coolmaths-products" style="background-color:rgb(25, 28, 36);width:100%;height:100%;display:block">
                    <center>
                        <h1 style="color:white; padding:30px" data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" data-aos-duration="3000">Purchase Our Products</h1>
                    </center>
                    <div class="products" id="product-content">
